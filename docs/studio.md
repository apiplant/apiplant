...
That API is the whole permission model, and it is the one thing to check before
starting: Chrome, Edge, Opera and Arc have it; Firefox and Safari do not, and
the studio says so rather than half-working.
