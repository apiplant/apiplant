 ...
 *
 * Everything here is deliberately plain. The dashboard is used by people who
 * did not write the application and are not trying to learn it, so the parts
 * they touch should look like parts they have touched before.
 */
