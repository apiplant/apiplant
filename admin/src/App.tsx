 ...
 *
 * The sidebar lists only what this operator can actually reach — resources
 * their role may see, actions they may run — so the navigation never offers a
...
function Navigation(props: { onNavigate: () => void }) {
  ...
  // identical headings listing different things is worse than none — so the
  // group only orders them here, and captions each item.
    ...
    <Switch fallback={<DashboardPage />}>
      ...
      >
        <EmptyState
          ...
          description="It may have been renamed or removed since your link was made."
        >
